...
public class UserActivity extends Activity implements OnClickListener {
	...
	private TextView userBack, userName, userPhone, userYuE, userSystem
			;
	// 充值按钮，消费记录按钮，清除缓存按钮，定位记录，设置页面，号码管理，退款记录
	...
	private final Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case HttpUtil.SUCCESS:
				// 获得余额
				if (msg.arg1 == 2) {
					Log.i("TAG", "yue"+msg.obj.toString());
...
//						打开友盟分享
						...
						shareUtil.shareNetImage( model.getShareinfo(),model.getShareTitle(),model.getShareImgUrl() ,model.getShareUrl());
					}else{
						ToastUtil.showCenterShort(UserActivity.this, RequestCode.NULL);
					}
				}
				//自动登录(刷新数据)
				if(msg.arg1 == LOGIN){
...
//				@Override
//				public void run() {
//					ToastUtil.showCenterShort(context, "清除缓存成功！");
//				}
//			}, 1000);
//		}
		if (v == userSystem) {
